(ns clj-delegate.monkey-patches.shady.defclass
  "Just to use a working version of shady.defclass/defclass with respect to
  namespace/class names including the '-' character.

  Copy-pasted from master/30595bf."
